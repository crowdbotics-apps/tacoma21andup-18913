"""tacoma21andup_18913 URL Configuration
...
admin.site.site_header = "Tacoma21andUp"
admin.site.site_title = "Tacoma21andUp Admin Portal"
admin.site.index_title = "Tacoma21andUp Admin"

# swagger
schema_view = get_schema_view(
    openapi.Info(
        title="Tacoma21andUp API",
        default_version="v1",
        description="API documentation for Tacoma21andUp App",
    ),
    public=True,
